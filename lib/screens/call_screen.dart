...
const AgoraAppID = '5de483920af04a59a432c6517d1ab768';
...
class CallPage extends StatefulWidget {
  ...
  const CallPage(
      {Key key, @required this.channelName, @required this.callToken})
      : super(key: key);
...
class _CallPageState extends State<CallPage> {
  ...
  void initState() {
    ...
    _requireCameraAndMic();
    initialize();
  }

  //Request permission
  Future<void> _requireCameraAndMic() async {
